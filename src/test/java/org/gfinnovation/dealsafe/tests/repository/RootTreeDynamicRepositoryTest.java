...
public class RootTreeDynamicRepositoryTest extends GenericBusinessRepositoryTest<RootTreeDynamicEntity> {
    String json = """
            {
              "nome": "João",
              "idade": 30,
    ...
    @Override
    protected RootTreeDynamicEntity createEntity() {
        String name = "Teste";
        UUID dynamicInput = UUID.randomUUID();
        return this.treeFactory.getRootTreeFactory().produce(name, dynamicInput);
    }

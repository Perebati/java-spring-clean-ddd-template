...
class ComparisonOperationRepositoryImpl
    ...
    @Transactional
    public ComparisonOperationEntity createComparison(ComparisonOperationEntity newOperation, NodeTree parent, RepositoryAuth auth) throws RepositoryException {
        try {

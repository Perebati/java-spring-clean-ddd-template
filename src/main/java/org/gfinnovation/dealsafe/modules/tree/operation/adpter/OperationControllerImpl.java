package org.gfinnovation.dealsafe.modules.tree.operation.adpter;
...
import org.gfinnovation.dealsafe.modules.tree.operation.adpter.interfaces.OperationController;
...
class OperationControllerImpl implements OperationController {
    ...
    public OperationControllerImpl(ComparisonOperationService operationService) {
        this.operationService = operationService;
    }

    @Override
    public ResponseEntity<ComparisonOperation> createOperation(OperationCreationDTO request) throws DomainException, BadRequestException {
        try {

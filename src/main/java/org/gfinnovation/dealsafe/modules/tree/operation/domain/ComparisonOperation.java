...
public class ComparisonOperation extends GenericBusinessEntity {
    ...
    @Default
    public ComparisonOperation(ComparisonTypeEnum comparisonTypeEnum, String jsonPath, Set<String> variables, Set<ActionOperation> actions) {
    ...
    public ComparisonOperation(ComparisonTypeEnum comparisonTypeEnum, String jsonPath, Set<String> variables) {
        this.comparisonTypeEnum = comparisonTypeEnum;
        this.jsonVariablePath = jsonPath;
        this.expectedVars = variables;
    }
